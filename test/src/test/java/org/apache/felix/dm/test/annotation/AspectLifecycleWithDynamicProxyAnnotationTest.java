...
public class AspectLifecycleWithDynamicProxyAnnotationTest extends AnnotationBase
{
    ...
    public static Option[] configuration()
    {
        return options(
            ...
            provision(
                new BundleGenerator()
                    .set(Constants.BUNDLE_SYMBOLICNAME, "AspectLifecycleDynamicProxyTest")
                    .set("Export-Package", "org.apache.felix.dm.test.bundle.annotation.sequencer")
                    .set("Private-Package", "org.apache.felix.dm.test.bundle.annotation.aspectlifecycledynamicproxy")
                    .set("Import-Package", "*")
