...
public class ConfigManager extends SimpleWebConsolePlugin implements OsgiManagerPlugin
{
    ...
    protected void renderContent( HttpServletRequest request, HttpServletResponse response ) throws IOException
    {
        ...
        String factoryCreate = request.getParameter( FACTORY_CREATE );
        vars.put( "factoryCreate", factoryCreate != null ? Boolean.valueOf(factoryCreate) : Boolean.FALSE); //$NON-NLS-1$
